...
angular.module('formly.render').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('vanilla/fields/formly-field-checkbox.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-email.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-hidden.html',
    "<input type=hidden ng-model=\"result[options.key || index]\">"
  );


  $templateCache.put('vanilla/fields/formly-field-number.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-password.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-radio.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-select.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-text.html',
  ...
  $templateCache.put('vanilla/fields/formly-field-textarea.html',
