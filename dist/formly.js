...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiCheck = apiCheckFactory({
	  output: {
	    ...
	    docsBaseUrl: __webpack_require__(4)
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var formlyApiCheck = _interopRequire(__webpack_require__(3));

	var formlyErrorAndWarningsUrlPrefix = _interopRequire(__webpack_require__(4));

	var formlyUsability = _interopRequire(__webpack_require__(5));

	var formlyConfig = _interopRequire(__webpack_require__(6));

	var formlyValidationMessages = _interopRequire(__webpack_require__(7));

	var formlyUtil = _interopRequire(__webpack_require__(8));

	var formlyWarn = _interopRequire(__webpack_require__(2));

	var formlyCustomValidation = _interopRequire(__webpack_require__(1));
