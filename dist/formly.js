// angular-formly version 3.3.1 built with ♥ by Astrism <astrisms@gmail.com>, Kent C. Dodds <kent@doddsfamily.us> (ó ì_í)=óò=(ì_í ò)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ngModule) {
	  ...
	  apiCheck.config.output = {
	    ...
	    docsBaseUrl: "https://github.com/formly-js/angular-formly/blob/" + ("3.3.1") + "/other/ERRORS_AND_WARNINGS.md#"
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ngModule) {
	  ngModule.constant("formlyVersion", ("3.3.1"));
	};
